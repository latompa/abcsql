...
fn data_type_display(dt: &parser::DataType) -> String {
    match dt {
        ...
        parser::DataType::Time => "TIME".into(),
        parser::DataType::Interval => "INTERVAL".into(),
        parser::DataType::Bit(Some(n)) => format!("BIT({})", n),
        parser::DataType::Bit(None) => "BIT".into(),
        parser::DataType::BitVarying(Some(n)) => format!("BIT VARYING({})", n),
        parser::DataType::BitVarying(None) => "BIT VARYING".into(),
